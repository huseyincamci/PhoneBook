...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:GridView ID="grvGorevler" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnRowDataBound="grvGorevler_RowDataBound" OnRowDeleting="grvGorevler_RowDeleting">
        <Columns>
            <asp:BoundField DataField="GorevId" HeaderText="#" />
