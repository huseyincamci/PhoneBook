...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
    <asp:GridView ID="gvBirimler" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateDeleteButton="True" OnRowDataBound="gvBirimler_RowDataBound" OnRowDeleting="gvBirimler_RowDeleting" AutoGenerateColumns="False" DataKeyNames="BirimId">
        <Columns>
